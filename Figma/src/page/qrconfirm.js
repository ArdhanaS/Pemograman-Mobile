    ...
    return (
        <View style={{ backgroundColor: 'white', flex: 1 }}>
            ...
            <View style={{ marginTop: 20, paddingVertical: 20, backgroundColor: '#4982C1', alignItems: 'center', marginHorizontal: 30 }}>
                ...
                < Text style={{ color: 'white', fontFamily: 'roboto', fontWeight: '500', fontSize: 24, marginTop: 10 }}>Telkom University</Text>
                < Text style={{ color: 'white', fontFamily: 'roboto', fontWeight: '500', fontSize: 16, marginTop: 10 }}>Jl. Telekomunikasi No. 1</Text>
            </View>
