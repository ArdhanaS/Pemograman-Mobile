        ...
        <View>
            ...
            <View style={{ backgroundColor: '#005690', padding: 30, alignItems: 'center' }}>
                <View style={{ borderRadius: 110, width: 110, height: 110, backgroundColor: '#FFFFFF', justifyContent: 'center', alignItems: 'center', marginBottom: 23 }}>
                    <Image source={require('../Assets/img/user.png')} style={{ width: '100%', height: '100%', borderRadius: 100 }} />
                </View>
                <Text style={{ fontSize: 18, fontWeight: '400', fontFamily: 'roboto', color: '#FFFFFF', marginBottom: 10 }}>ARDHANA SETYADI</Text>
                <Text style={{ fontSize: 18, fontWeight: '400', fontFamily: 'roboto', color: '#FFFFFF' }}>081297184137</Text>
            </View>
            {/* button edit */}
