...
function TabScreen() {
  return (
    <Tab.Navigator>
      <Tab.Screen name="HomeScreen" component={HomeScreen} options={{ headerShown: false, tabBarIcon: tabState => { return (<Home width={30} height={30} fill={tabState.focused ? '#005690' : '#000'} />) } }} />
      <Tab.Screen name="Profile" component={Profile} options={{ headerShown: false, tabBarIcon: tabState => { return (<Identity width={30} height={30} fill={tabState.focused ? '#005690' : '#000'} />) } }} />
      <Tab.Screen name="History" component={History} options={{ headerShown: false, tabBarIcon: tabState => { return (<Swap width={30} height={30} fill={tabState.focused ? '#005690' : '#000'} />) } }} />
